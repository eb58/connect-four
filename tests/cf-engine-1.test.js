...
describe('WIN 1 ', () => {
  ...
  test('win05', () => h('win05', { fen: '44444646323336621223356625555', depth: 8, bestMove: 5 }))
  test('win06', () => h('win06', { fen: '4744352114132443221132377', bestMove: 7 }))
  test('win07', () => h('win07', { fen: '4451', bestMoves: [3, 5] }))
  test('win08', () => h('win08', { fen: '3353', depth: 2, bestMove: 4 }))
  test('win09', () => h('win09', { fen: '6554532355664644443333', depth: 10, bestMove: 5 }))
  test('win10', () => h('win10', { fen: '5443441333443322', depth: 14, bestMove: 5 }))
  test('win11', () => h('win11', { fen: '444342442122152211', depth: 16, bestMove: 5 }))
  test('win12', () => h('win12', { fen: '434232', bestMove: 4 }))
  test('win13', () => h('win13', { fen: '434233445215445633', depth: 18, bestMove: 2 }))
  test('win14', () => h('win14', { fen: '6165173152', bestMoves: 3 }))
})
